...
[![Scan Node project with deps_install_cmd](https://github.com/redhat-actions/crda/actions/workflows/scan_custom_deps.yml/badge.svg)](https://github.com/redhat-actions/crda/actions/workflows/scan_custom_deps.yml)
